...
import { useClassValidatorToNestedDto } from './rules/use-class-validator-to-dto/use-class-validator-to-nested-dto'
...
export const rules = {
  ...
  use_class_validator_to_nested_dto: useClassValidatorToNestedDto
}
...
export const configs = {
  recommended: {
    rules: {
      ...
      'authing-nestjs/use_class_validator_to_nested_dto': 2
    }
  }
}
